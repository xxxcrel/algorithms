...
public class InplaceMSD
{
	...
	/**
	 * Rearranges the array of extended ASCII strings in ascending order. This is an
	...
	/**
	 * Reads in a sequence of extended ASCII strings from standard input; in-place
	 * MSD radix sorts them; and prints them to standard output in ascending order.
	 *
