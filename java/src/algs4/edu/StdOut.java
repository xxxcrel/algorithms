...
public final class StdOut
{
	 ...
	 *
	 * @deprecated Calling close() permanently disables standard output; subsequent
	 *             calls to StdOut.println() or System.out.println() will no longer
	 *             produce output on standard output.
	 */
	@Deprecated
