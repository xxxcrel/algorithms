...
import algs4.edu.StdOut;
import algs4.edu.StdRandom;
import algs4.edu.In;
import algs4.fundamentals.Stack;
import algs4.fundamentals.Queue;
import algs4.searching.SET;
...
public class DigraphGenerator
{
	...
	/**
	 * Returns the complete digraph on {@code V} vertices. In a complete digraph,
	 * every pair of distinct vertices is connected by two antiparallel edges. There
	 * are {@code V*(V-1)} edges.
	 *
	 * @param V the number of vertices
	...
	/**
	 * Returns a complete rooted-in DAG on {@code V} vertices. A rooted in-tree is a
	 * DAG in which there is a single vertex reachable from every other vertex. A
	 * complete rooted in-DAG has V*(V-1)/2 edges.
	 *
	 * @param V the number of vertices
	...
	/**
	 * Returns a complete rooted-out DAG on {@code V} vertices. A rooted out-tree is
	 * a DAG in which every vertex is reachable from a single vertex. A complete
