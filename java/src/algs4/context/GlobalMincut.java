...
import algs4.graphs.EdgeWeightedGraph;
import algs4.graphs.Edge;
import algs4.fundamentals.UF;
import algs4.sorting.IndexMaxPQ;
...
public class GlobalMincut
{
	 ...
	 * @throws IllegalArgumentException if the number of vertices of {@code G} is
	 *                                  less than {@code 2} or if anny edge weight
	 *                                  is negative
	 */
	 ...
	 * @param G the edge-weighted graph
	 * @throws IllegalArgumentException if the number of vertices of {@code G} is
	 *                                  less than {@code 2} or if any edge weight is
	 *                                  negative
	 */
	 ...
	 * @throws IllegalArgumentException unless vertex {@code v} is between {@code 0}
	 *                                  and {@code (G.V() - 1)}
	 */
	 ...
	 *
	 * @param G      the edge-weighted graph
	 * @param marked the array of contracted vertices, where {@code marked[v]} is
