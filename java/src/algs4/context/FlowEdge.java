...
public class FlowEdge
{
	 ...
	 * @throws IllegalArgumentException unless {@code flow} is between {@code 0.0}
	 *                                  and {@code capacity}.
	 */
	 ...
	 * @throws IllegalArgumentException if {@code vertex} is not one of the
	 *                                  endpoints of the edge
	 * @throws IllegalArgumentException if {@code delta} makes the flow on on the
	 *                                  edge either negative or larger than its
	 *                                  capacity
