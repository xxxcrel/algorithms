...
public class IndexBinomialMinPQ<Key> implements Iterable<Integer>
{
	 ...
	 * {@code N-1} Worst case is O(n)
	 * 
	 * @param N          number of keys in the priority queue, index from {@code 0}
	 *                   to {@code N-1}
	 ...
	 * @throws java.lang.IllegalArgumentException if the specified index is invalid
	 * @throws java.lang.IllegalArgumentException if the index has no key associated
	 *                                            with
	 */
	 ...
	 * @param key the key to associate with i
	 * @throws java.lang.IllegalArgumentException if the specified index is invalid
	 * @throws java.util.NoSuchElementException   if the index has no key associated
	 *                                            with
	 * @throws java.lang.IllegalArgumentException if the given key is greater than
	 *                                            the current key
	 */
	 ...
	 * @throws java.util.NoSuchElementException   if the index has no key associated
	 *                                            with
	 * @throws java.lang.IllegalArgumentException if the given key is lower than the
	 *                                            current key
	 */
